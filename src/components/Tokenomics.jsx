const Tokenomics = () => {
  return (
    <div className="bg-[#4c9540]">
      <div className="font-comportaa min-h-screen flex items-center text-white text-2xl ml-20 mr-20">
        <img
          src="./images/3.webp"
          alt="3"
          style={{ width: "563px", height: "564px" }}
        />
        <div className="ml-10 text-center">
          <h3 className="text-center text-7xl p-2 mb-10">about</h3>
          <h5 className="text-left  mr-20 mb-10">
